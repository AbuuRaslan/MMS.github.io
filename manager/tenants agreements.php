...
if (isset($_POST["button"])) {
  ...
  $city=$_POST["city"];
  $state=$_POST["state"];
  $details= "INSERT INTO tenants_details(tenantID,FullName,gender,phone_number, email) values('$id','$name','$gender','$cnum','$email')";
  $adres= "INSERT INTO tenants_address(tenantID,address,city,state) values('$id','$address','$city','$state')";
  $logindetails="INSERT INTO tenant_login(username,password,tenantID,email) values('$email','$id','$id','$email')";
  $send=mysqli_query($con,$logindetails);
  ...
  <body>
    ...
    <center ><main class=" pt-5 col-10 col-lg-9 sm-10 " style="  width: 82%;" >
      ...
      <div class="album py-5 bg-light album">
        ...
        <form class="row g-3 ms-auto agree " action="register tenant.php" method="POST">
          <h2 >Tenant agreements</h2>
          <center><div class="col-md-4">
            <label for="inputEmail4" class="form-label">Starting Phase</label>
            <input type="number" class="form-control" id="input name" name="phase" required>
          </div></center>
          <center><div class="col-md-4">
            <label for="inputEmail4" class="form-label">property name</label>
            <input type="text" class="form-control" id="input name" name="pname" required>
          </div></center>
          <center><div class="col-md-4">
            <label for="inputPassword4" class="form-label">floor number</label>
            <input type="number" class="form-control" id="" name="fnum" required>
          </div></center>
          <center><div class="col-md-4">
            <label for="inputAddress2" class="form-label">rental amount</label>
            <input type="number" class="form-control" id="inputAddress2" placeholder="In USD($)" name="ramount" required>
          </div></center>
          <center><div class="col-md-4">
            <label for="inputState" class="form-label">payments frequency</label>
            <select id="inputState" class="form-select" placeholder="example: tanzania" name="pfr" required>
          ...
          <center><div class="col-md-4">
            <label for="inputCity" class="form-label">lease start date</label>
            <input type="date" class="form-control" id="inputCity" name="lsd" required>
          </div></center>
          <center><div class="col-md-4">
            <label for="inputCity" class="form-label">lease end date</label>
            <input type="date" class="form-control" id="inputCity" name="led" required>
          </div></center>
          <br><br><br>
          <div class="col-12">
          ...
          <div class="col-md-4" style="display: none;">
            <textarea id="id" name="tid" ></textarea>
