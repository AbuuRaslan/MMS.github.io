...
if(!$_SESSION['username']) {
  ...
  tenants_details.gender, 
  tenants_details.phone_number, 
  tenants_details.email,
  tenants_address.address,
  tenants_address.city,
  tenants_address.state 
  FROM tenants_details INNER JOIN tenants_address ON tenants_details.tenantID = tenants_address.tenantID; ";
  ...
  <body>
   ...
   <center ><main class=" pt-5 col-10 col-lg-9 sm-10 " style="  width: 82%;" >
      <div class="album py-5 bg-light album">
        ...
        <h1 class="mt-4">EXACT LIST OF TENANTS</h1>
        <hr>
                ...
                <table id="printableTable" class="table table-striped table-bordered table-hover">
                    <tbody>
                          ...
                          <tr class="text-uppercase">
                              ...
                              <th>gender</th><th>Phone number</th><th>email</th><th>address</th><th>city</th><th>state</th>
                          </tr>
                      </thead>
                    <tbody>
                    <tr>
