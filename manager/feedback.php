...
if(!$_SESSION['username']) {
  ...
  $manager="MANAGER";
  $select = " SELECT * FROM messages WHERE subject ='FEED BACK' ";
...
<html>
  ...
  <body>
    ...
    <!--------------------------------------------off convas end ---------------------------------------->
   <center ><main class=" pt-5 col-10 col-lg-9 sm-10 " style="  width: 82%; background-color:white;" >
                 ...
                 ?>
                  <li class="list-group-item" style="border-radius:30px; background-color:#FBE9E7;">
                    <div class="d-flex justify-content-between" >
                      <h6 class="mb-0">FROM <?php echo " ". $fetch['ffrom']; ?></h6>
