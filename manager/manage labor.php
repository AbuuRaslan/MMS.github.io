...
if(!$_SESSION['username']) {
  ...
  labor_agreements.labor_type,
  labor_agreements.responsibles, 
  labor_agreements.salary_amount,
  labor_agreements.salary_frequency 
  FROM labor_details INNER JOIN labor_agreements ON labor_details.laborID=labor_agreements.laborID ORDER BY laborID ASC;";
                    ...
                    <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" style="background-image: linear-gradient(to top,#1a4547,black);">
                      ...
                      <form method="POST" action="delete.php" class="dropdown-menu p-4 text-white" style="width:300px;  background-color: rgba(18, 0,15,0.8); box-shadow: 0px 0px 50px black; border: none; border-radius: 10px;">
                        <div class="mb-3">
                          ...
                          <input type="ID" class="form-control"  placeholder="Labor ID" name="lid" required>
                        </div>
                        <center> <button type="submit" class="btn btn-primary" name="btnldelete" style="background-image: linear-gradient(to top,#1a4547,black);" onclick="return confirm('sure you want to delete that employee?');">DELETE</button>
                      </form>
                    </div>        
                ...
                <table id="printableTable" class="table table-striped table-bordered table-hover">
                    <tbody>
                          ...
                          <tr>
                              ...
                              <th>GENDER</th><th>CONTACT NUMBER</th><th>EMPLOYEE TYPE</th><th>RESPONSIBLE</th><th>SALARY AMOUNT</th><th>SALARY FREQUENCY</th>
                          </tr>
                        </thead>
                        <tr>
                          <?php 
                          ...
                          <td><?php echo $fetch['labor_type']; ?></td>
                          <td><?php echo $fetch['responsibles']; ?></td>
                          <td><?php echo $fetch['salary_amount']; ?></td>
                          <td><?php echo $fetch['salary_frequency']; ?></td>
                        </tr>
                          <?php
                          } 
