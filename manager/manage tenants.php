...
if(!$_SESSION['username']) {
  ...
  FROM tenants_details INNER JOIN tenants_agreements ON tenants_details.tenantID = tenants_agreements.tenant_ID ORDER BY tenantID ASC; ";
  ...
  <body>
   ...
   <center ><main class=" pt-5 col-10 col-lg-9 sm-10 " style="  width: 82%;" >
      <div class="album py-5 bg-light album">
          ...
          <div class="container nav-container">
            <div class="collapse" id="navbarToggleExternalContent">
              <div class="bg-dark p-4">
                <button type="submit" class="btn btn-primary me-5">UPDATE TENATS</button>
                <button type="button" class="btn btn-danger ms-5">REMOVE TENANTS</button>
              </div>
            </div>
                ...
                <center>
                  ...
                  <center>
                    <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" style="background-image: linear-gradient(to top,#1a4547,black);">
                      ...
                      <form method="POST" action="delete.php" class="dropdown-menu p-4 text-white" style="width:300px;  background-color: rgba(18, 0,15,0.8); box-shadow: 0px 0px 50px black; border: none; border-radius: 10px;">
                        <div class="mb-3">
                          <label  class="form-label">Tenant ID</label>
                          <input type="ID" class="form-control"  placeholder="tenant ID" name="tid" required>
                        </div>
                        <center> <button type="submit" class="btn btn-primary" name="btndelete" style="background-image: linear-gradient(to top,#1a4547,black);" onclick="return confirm('sure you want to delete that tenant?');">DELETE</button>
                      </form>
                    </div>        
                  </center>
        ...
        <h1 class="mt-4">TENANTS MANAGEMENT</h1>
        <hr>
        <div class="row agree" style=" overflow-x: scroll; width:100%;">
            <div id="printThis_table" >
                <table id="printableTable" class="table table-condensed table-bordered table-hover">
                    <tbody>
                      </tbody><thead>
                          <tr>
                              <th>TENANT ID</th><th>TENANT NAME</th>
                              <th>CONTACT NUMBER</th><th>PROPERTY NAME</th><th>FLOOR NUMBER</th><th>LEASE-START DATE</th><th>LEASE-END DATE</th><th>RENTAL AMOUNT</th>
                          </tr>
                      </thead>
                    <tbody>
                    <tr>
                      ...
                      <td>+255 <?php echo $row['phone_number']; ?> </td>
                      ...
                      ?>
                          <tr>
                            <th class="text-center text-muted" colspan="8" ><h1>No data available</h1></th>
                          </tr>
                      <?php
                        }
                      ?>
