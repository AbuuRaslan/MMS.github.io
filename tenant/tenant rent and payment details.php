    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <center>
        ...
        <div class="input-group mb-3 my-3 my-lg-0">
          ...
          <button class="btn  me-auto" type="button" style=" cursor:default; color:white;">WELCOME <?php echo " ".$fetch1['FullName']; ?> </button>
        </div>
        </form>
      </center>
    ...
    <div class="rent-card" >
      ...
      <?php 
       while ($fetch4=mysqli_fetch_assoc($query4)) {
        $i = $fetch4['phase'];
        $j=$fetch4['rental_amount'];
        $p = $fetch4['amount_payed']; 
        $d = $fetch4['amount_due'];
      } 
      ?>
      <p><strong class="me-5">Property Name: </strong><?php echo $fetch2['property_name'] ; ?></p>
      <p><strong class="me-5">Current Phase:</strong> <?php echo $i; ?> </p>
      <p><strong class="me-5">Rent Amount:</strong> <?php echo("$".$j); ?> </p>
      <p><strong class="me-5">amount payed:</strong> <?php echo("$".$p); ?></p>
      <p><strong class="me-5">amount due:</strong> <?php echo"$".($d); ?> </p>
    </div>

    <hr>

    <div class="rent-card" style=" height:27vh; overflow-y:scroll;">
      <h4>Payment History</h4>
      <div class="table-responsive payment-table"  >
        <table class="table table-striped" >
          <thead>
            <th>Phase</th><th>Payment Date</th><th>Amount Payed</th>
            <tr>
             <?php
                while (  $fetch5=mysqli_fetch_assoc($query5)) {
              ?>
                <td><?php echo $fetch5['phase']; ?></td>
                <td> <?php echo $fetch5['payment_date']; ?> </td>
                <td> <?php echo $fetch5['amount']; ?> </td>
            </tr>
